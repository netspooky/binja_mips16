    ...
    * If extended then length +=2
    ...
    for mips16_insn in mips16_opcodes:
      ...
      if (mips16_insn[3] & unpacked_insn) == mips16_insn[2]:
        ...
        if insn['insn'] == 'lb': insn['args'] = m16e_lb(unpacked_insn, extend_val)
        if insn['insn'] == 'lbu': insn['args'] = m16e_lbu(unpacked_insn, extend_val)
        if insn['insn'] == 'lh': insn['args'] = m16e_lh(unpacked_insn, extend_val)
        if insn['insn'] == 'lhu': insn['args'] = m16e_lhu(unpacked_insn, extend_val)
        if insn['insn'] == 'li': insn['args'] = m16e_li(unpacked_insn, extend_val)
